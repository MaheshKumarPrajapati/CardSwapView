...
import com.mahesh_prajapati.cardswapview.internal.CardStackSetting
import com.mahesh_prajapati.cardswapview.internal.CardStackSmoothScroller
import com.mahesh_prajapati.cardswapview.internal.CardStackState
import com.mahesh_prajapati.cardswapview.internal.DisplayUtil
...
class CardStackLayoutManager(
    ...
    private fun update(recycler: Recycler) {
        ...
        if (cardStackState.isSwipeCompleted) {
             ...
             *     java.lang.IllegalStateException: Cannot call this method while RecyclerView is computing a layout or scrolling com.yuyakaido.android.cardstackview.CardStackView{9d8ff78 VFED..... .F....ID 0,0-1080,1353 #7f080027 app:id/card_stack_view}, adapter:com.mahesh_prajapati.matchingapp.ui.main.adapter.CardStackAdapter@e0b8651, layout:com.yuyakaido.android.cardstackview.CardStackLayoutManager@17b0eb6, context:com.yuyakaido.android.cardstackview.sample.MainActivity@fe550ca
    ...
    private fun updateOverlay(view: View) {
        val leftOverlay =
            view.findViewById<View>(R.id.left_overlay)
        if (leftOverlay != null) {
            leftOverlay.alpha = 0.0f
        }
        val rightOverlay =
            view.findViewById<View>(R.id.right_overlay)
        ...
        val bottomOverlay =
            view.findViewById<View>(R.id.bottom_overlay)
