...
import com.mahesh_prajapati.cardswapview.internal.CardStackDataObserver
import com.mahesh_prajapati.cardswapview.internal.CardStackSnapHelper
...
class CardStackView @JvmOverloads constructor(
    ...
    override fun setLayoutManager(manager: LayoutManager?) {
        if (manager is com.mahesh_prajapati.cardswapview.CardStackLayoutManager) {
