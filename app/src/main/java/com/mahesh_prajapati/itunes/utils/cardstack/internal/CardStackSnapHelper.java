...
import com.mahesh_prajapati.itunes.utils.cardstack.CardStackLayoutManager;
import com.mahesh_prajapati.itunes.utils.cardstack.Duration;
import com.mahesh_prajapati.itunes.utils.cardstack.SwipeAnimationSetting;
    ...
    public int[] calculateDistanceToFinalSnap(
        ...
        if (layoutManager instanceof CardStackLayoutManager) {
            ...
            if (manager.findViewByPosition(manager.getTopPosition()) != null) {
                ...
                if (x != 0 || y != 0) {
                    com.mahesh_prajapati.itunes.utils.cardstack.internal.CardStackSetting setting = manager.getCardStackSetting();
